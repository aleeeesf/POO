...
{		
	...
	switch(t.tipo()){
		...
		case Tarjeta::Otro: os<<"Otro"<<endl;
				   break;
		
		case Tarjeta::VISA:	os<<"VISA"<<endl;
					break;
		
		case Tarjeta::Mastercard: os<<"Mastercard"<<endl;
						 break;
		
		case Tarjeta::Maestro: os<<"Maestro"<<endl;
					  break;
		
		case Tarjeta::JCB: os<<"JCB"<<endl;
				  break;
		
		case Tarjeta::AmericanExpress: os<<"AmericanExpress"<<endl;
							  break;
